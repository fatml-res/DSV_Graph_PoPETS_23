...
flags.DEFINE_string('dataset', 'cora',
                    'Dataset string.')  # 'cora', 'citeseer', 'pubmed'
flags.DEFINE_string("datapath", "data/dataset/original/",
                    "Datapath string.")  # "data/dataset/walk2friends"
flags.DEFINE_string("prediction_path", "data/pred/", "model prediction path")
...
for epoch in range(FLAGS.epochs):
    ...
    # Print results
    print("Model:", FLAGS.model, "Dataset:", FLAGS.dataset, "Epoch:",
...
with open("data/pred/%s_%s_pred.pkl" % (FLAGS.dataset, FLAGS.model),"wb") as wf:
    wf.write(pkl.dumps(test_pred))
